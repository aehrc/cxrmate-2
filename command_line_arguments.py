...
def read_command_line_arguments():
    ...
    model.add_argument(
        "--upload", action="store_const", const=True, help="Upload the model to Hugging Face Hub"
    )
    ...
    train.add_argument("--monitor", type=str, help="Metric to monitor")
    train.add_argument(
        "--monitor-mode",
        "--monitor_mode",
        type=str,
    ...
    train.add_argument(
        ...
        type=int,
        default=50,
        help="Log the loss every n steps",
    )
    train.add_argument(
        "--limit-train-samples",
        "--limit_train_samples",
    ...
    test.add_argument(
        ...
        type=int,
        default=None,
        help="Limit the number of testing samples",
    )
    ...
    cluster.add_argument("--accelerate-exec-path", "--accelerate_exec_path", type=str, help="Executable path for accelerate")
    ...
    cluster.add_argument('--entrypoint', type=str, help='Entrypoint for the script')
